...
urlpatterns = [
    ...
    path(
        "api/audio/chunk/<int:chunk_id>/",
        english_audio_views.get_chunk,
        name="get chuck",
    ),
    path(
        "api/audio/chunk/transcript/<int:chunk_id>/",
        english_audio_views.audio_transcript,
        name="audio transcript",
    ),
    path(
        "api/audio/chunk/transcript/delete/<int:chunk_id>/",
        english_audio_views.delete_transcript,
